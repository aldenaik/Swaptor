...
// Create a bucket and put image in it. I had to use the name because amazon doesnt accept email address...
        var s3 = new AWS.S3();
        s3.client.createBucket({Bucket: req.user.name+"1212121212"}, function() {
            var data = {Bucket: req.user.name+"1212121212", Key: req.files.displayImage.originalFilename, Body: base64data};
...
//        res.redirect('/profile');         // shut down the connection pool, no more messages
    ...
    var newtradingItems = new TradingItems({
        name: req.body.name,
        image: "https://s3.amazonaws.com/swapter1/"+ req.files.displayImage.originalFilename,
        description: req.body.description,
        want: req.body.want,
        categories: req.body.categories,
        email: req.user.email
    });
//    console.log(req.body); ///where image is kept
...
//    var newtradingItems = new TradingItems({
//        name: req.body.name,
//        image: req.files.displayImage.originalFilename,
//        description: req.body.description,
//        want: req.body.want,
//        categories: req.body.categories
